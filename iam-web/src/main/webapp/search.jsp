...
<body>
			...
			<div class="table-responsive">
				<table class="table">
					...
					<tbody>
		               ...
		               <form class="form-horizontal" role="form" method="GET" action="Delete">
			               <button input style="float:right; margin-right:15px; type="submit" class="btn btn-primary">Delete</button>
		                 </form>
				<div class="form-group">
					<div class=" col-sm-offset-2 col-sm-10 text-right">
	...
	<form class="form-horizontal" role="form" method="GET" action="Modify">
			               <button input style="float:right; margin-right:12px; type="submit" class="btn btn-primary">Modify</button>
	                    </form>
				</div>
	</div>
</body>
